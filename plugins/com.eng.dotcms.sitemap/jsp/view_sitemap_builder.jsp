...
<div class="portlet-wrapper">
	...
	<div id="mainTabContainer" dojoType="dijit.layout.TabContainer" dolayout="false">
		<div id="control-panel-tab" dojoType="dijit.layout.ContentPane" title="<%= LanguageUtil.get(pageContext, "sitemap-builder-control-panel") %>" >
