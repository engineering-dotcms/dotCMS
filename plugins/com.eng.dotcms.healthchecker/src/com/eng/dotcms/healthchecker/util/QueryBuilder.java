...
public class QueryBuilder {
	...
	public static final String ORACLE_GET_NODE_LEAVE					=	"SELECT * FROM HEALTH_EVENT WHERE ADDRESS = ? AND STATUS='LEAVE' ORDER BY MOD_DATE DESC";
	...
	public static final String ORACLE_CHECK_JOIN_AFTER_LEAVE			=	"SELECT count(*) AS NUM_JOINED_AFTER FROM HEALTH_EVENT WHERE ADDRESS = ? AND STATUS = 'JOIN' AND MOD_DATE > ?";
}
