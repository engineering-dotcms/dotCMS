...
<style>
	.wrapper{background:url(/html/plugins/com.eng.dotcms.healthchecker/images/healthchecker-promo.png) no-repeat 0 0;width:1183px;height:800px;margin:0 auto;}
...
<div class="wrapper">
	<div class="content">
		<h2><%=LanguageUtil.get(pageContext, "javax.portlet.title.EXT_HEALTH_CHECKER_CLUSTER_TOOL")%></h2>
