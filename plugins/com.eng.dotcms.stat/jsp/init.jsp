...
<%if(layout==null){
	...
	for(Layout l : myLayouts){
		...
		if(ports.contains("PLUGIN_CLICKSTREAM_STAT_BANKIT")){
			layout = l;
			layoutId=l.getId();
			break;
		}
...
String referer = new URLEncoder().encode("/c/portal/layout?p_l_id=" + layoutId + "&p_p_id=PLUGIN_CLICKSTREAM_STAT_BANKIT&");%>
