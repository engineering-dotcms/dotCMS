...
<%
	String portletId1 = "EXT_CONTENTLET_WHATS_CHANGED";
	...
	params.put("struts_action",new String[] {"/ext/contentlet/view_whats_changed"});
...
<script language="Javascript">
        ...
        <%@ include file="/html/plugins/com.eng.dotcms.contentlet.whatschanged/view_whats_changed_js_inc.jsp" %>
...
<!-- START Button Row -->
        ...
        <div class="buttonBoxRight">
             <i><%=LanguageUtil.get(pageContext, "Show-Versions-Description") %>.</i>
        </div>
...
<input type="hidden" name="selected_contentlet_id" id="selected_contentlet_id" value="">
          ...
          <!-- START Buton Row -->
                        <div class="buttonRow">
                                ...
                                <div id="unArchiveButtonDiv">
                                        <button dojoType="dijit.form.Button" id="showVersionsButton"  onClick="showContentletVersions()" iconClass="publishIconDis" disabled="true">
                                                <%= UtilMethods.escapeSingleQuotes(LanguageUtil.get(pageContext, "Show-Versions")) %>
                                        </button>
                                </div>
                        </div>
                <!-- END Buton Row -->
