...
public class WhatsChangedAction extends DotPortletAction {
	...
	public ActionForward render(ActionMapping mapping, ActionForm form, PortletConfig config, RenderRequest req,
		...
		Logger.debug(WhatsChangedAction.class, "Running WhatsChangedAction!!!!");

		try {
			// gets the user
			User user = _getUser(req);
			_viewContentlets(req, user);
			return mapping.findForward("portlet.ext.contentlet.view_whats_changed");
