...
%>
   ...
   //Asset Actions
	...
	function viewFile(objId,inode, fileExt) {
		window.open('/dotAsset/' + objId + '.' + fileExt + '_' + inode +"&random=<%=UtilMethods.getRandomNumber(100000)%>",'fileWin','toolbar=no,resizable=yes,width=400,height=300');
	}
